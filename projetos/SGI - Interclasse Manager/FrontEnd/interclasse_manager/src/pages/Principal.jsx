...
export default function Principal() {
  ...
  useEffect(() => {
    ...
    // Se não houver dados via state nem em localStorage (com lembrar=true), redireciona
  ...
  const sair = () => {
    // Remover chaves usadas pelo app
    ...
    navigate("/", { replace: true });
    // Garantir reload para limpar qualquer estado de rota
    setTimeout(() => window.location.replace("/"), 50);
  };
